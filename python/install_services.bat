...
set PROJECT_PATH=C:\xampp\htdocs\iotsf\python
...
nssm install .SocketServerService "%PYTHON_PATH%" "%PROJECT_PATH%\socket_server.py"
nssm set .SocketServerService AppDirectory "%PROJECT_PATH%"
nssm set .SocketServerService Start SERVICE_AUTO_START
nssm set .SocketServerService AppStdout "%PROJECT_PATH%\logs\socket_log.txt"
nssm set .SocketServerService AppStderr "%PROJECT_PATH%\logs\socket_error.txt"
nssm set .SocketServerService AppExit Default Restart

echo.
echo Installing TaskCameraService...
nssm install .TaskCameraService "%PYTHON_PATH%" "%PROJECT_PATH%\taskcamera_server.py"
nssm set .TaskCameraService AppDirectory "%PROJECT_PATH%"
nssm set .TaskCameraService Start SERVICE_AUTO_START
nssm set .TaskCameraService AppStdout "%PROJECT_PATH%\logs\camera_log.txt"
nssm set .TaskCameraService AppStderr "%PROJECT_PATH%\logs\camera_error.txt"
