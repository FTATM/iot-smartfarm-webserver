...
// ============================================================
$base_url = 'http://localhost/iotsf/api-website/AI-monitors-summary.php'; // เปลี่ยนเป็น URL ที่ถูกต้องของ AI-Summary.php
...
// foreach ($branches as $branch) {
    ...
    $bid = 3; // ทดสอบกับ branch เดียวก่อน
...
$prompt = <<<PROMPT
SYSTEM:
คุณคือระบบ AI ตัดสินใจควบคุม Sensor อัตโนมัติ 
