...
<body>
    ...
    <header class="flex items-center justify-between p-4 border-b border-stone-200 bg-white shrink-0">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-[#1d130c] text-[1.5vw] text-lg font-bold leading-none">Indoor System</h1>
                <p class="text-[0.75vw] text-stone-500 font-medium uppercase tracking-wider mt-1">Indoor Dashboard</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 h-full">
            ...
            <div class="col-span-2 grid grid-rows-4 gap-3 h-full" id="stats-sidebar">
                    ...
                    <div class="grid grid-cols-1 gap-1">
                        ...
                        <div class="flex justify-between items-center bg-stone-50 p-2 2xl:p-8 rounded-lg border border-stone-100">
                            <div>
                                ...
                                <p class="text-[1vw] font-bold text-slate-800" id="main-task">-</p>
                            </div>
                            <div class="text-right">
                                <p class="text-[0.75vw] text-[#ff8021] font-bold uppercase tracking-wider">ดินที่แนะนำ</p>
                                <p class="text-[1vw] font-bold text-slate-800" id="recommended-soil">-</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-4 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0">
                    ...
                    <div class="space-y-2 2xl:space-y-8">
                        <!-- Grid 2 Columns -->
                        <div class="grid grid-cols-2 gap-1 2xl:gap-8">
                            <div class="bg-blue-50 p-2 rounded-lg border border-blue-100">
                                <p class="text-[0.75vw] 2xl:text-2xl 2xl:px-8 text-blue-500 font-bold uppercase mb-0.5">ตารางเวลา</p>
                                <p class="text-[1vw] 2xl:text-2xl 2xl:px-8 font-bold text-blue-600" id="watering-schedule">-</p>
                            </div>
                            <div class="bg-stone-50 p-2 2xl:p-4 rounded-lg border border-stone-100">
                                <p class="text-[0.75vw] text-slate-500 font-bold uppercase mb-0.5">ปุ๋ย</p>
                                <p class="text-[1vw] font-bold text-red-400" id="fertilizer-status">-</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between bg-red-50 p-4 2xl:p-8 rounded-lg border border-red-100">
                            <div class="flex items-center gap-1 ">
                                <span class="material-symbols-outlined text-red-600 text-[1vw]">warning</span>
                                <span class="text-[0.75vw] font-bold text-red-700">ศัตรูพืช</span>
                            </div>
                            <span class="text-[0.75vw] font-medium text-red-600" id="pest-alert">-</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-2 2xl:px-8 2xl:space-y-4">
                        ...
                        <div class="flex items-center justify-between p-1 2xl:px-4 bg-green-50 rounded-md border border-green-100">
                            <div class="flex items-center gap-1">
                                ...
                                <span class="text-[0.75vw] font-bold text-green-700 uppercase 2xl:px-4">Hardware</span>
                            </div>
                            <span class="text-[0.75vw] font-bold text-green-700" id="expense-hardware">-</span>
                        </div>

                        <!-- Infrastructure -->
                        <div class="flex items-center justify-between p-1 2xl:px-4 bg-yellow-50 rounded-md border border-yellow-100">
                            <div class="flex items-center gap-1">
                                <span class="material-symbols-outlined text-yellow-600 text-[1vw]">warning</span>
                                <span class="text-[0.75vw] font-bold text-yellow-700 uppercase 2xl:px-4">Infrastructure</span>
                            </div>
                            <span class="text-[0.75vw] font-bold text-yellow-700" id="expense-infrastructure">-</span>
                        </div>

                        <!-- Miscellaneous -->
                        <div class="flex items-center justify-between p-1 2xl:px-4 bg-red-50 rounded-md border border-red-100">
                            <div class="flex items-center gap-1">
                                <span class="material-symbols-outlined text-red-600 text-[1vw]">error</span>
                                <span class="text-[0.75vw] font-bold text-red-700 uppercase 2xl:px-4">Miscellaneous</span>
                            </div>
                            <span class="text-[0.75vw] font-bold text-red-700" id="expense-miscellaneous">-</span>
                        </div>

                        <!-- Total -->
                        <div class="pt-1.5 2xl:px-8 mt-0.75 border-t border-slate-200 flex justify-between items-center">
                            <span class="font-bold text-slate-800 uppercase text-[0.75vw] tracking-wider">Total</span>
                            <span class="font-bold text-[1vw] text-primary" id="expense-total">-</span>
                        </div>
                    </div>
                </div>
