        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-10 gap-3 min-h-0 bg-white dark:bg-stone-950">
                <div class="flex-grow space-y-6">
                    <div
                        class="bg-white dark:bg-stone-900 box p-4 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 flex flex-wrap gap-4 items-center justify-between">
                    ...
                    <div
                        class="bg-white dark:bg-stone-900 box rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 overflow-hidden">
                            ...
                            <table id="table-view" class="w-full text-left border-collapse">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-6 py-4 text-[0.75vw] font-bold text-stone-500 dark:text-white uppercase">Branch ID
                                        </th>
                                        <th class="px-6 py-4 text-[0.75vw] font-bold text-stone-500 dark:text-white uppercase">Amount
                                            (฿)</th>
                                        <th class="px-6 py-4 text-[0.75vw] font-bold text-stone-500 dark:text-white uppercase">Category
                                        </th>
