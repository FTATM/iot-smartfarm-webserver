...
<body class="h-screen overflow-hidden flex flex-col">
    ...
    <main class="flex-1 flex flex-col p-[0.5vw] gap-3 overflow-hidden min-h-0 dark:bg-stone-950">
        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-10 gap-3 min-h-0 bg-white dark:bg-stone-950">
                <div class="flex-grow space-y-6">
                    <div
                        class="bg-white dark:bg-stone-900 p-4 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 flex flex-wrap gap-4 items-center justify-between">
                        ...
                        <div class="relative w-full sm:w-[25vw]">
                            <span
                                class="material-icons-round absolute left-3 top-1/2 -transtone-y-1/2 text-stone-400 text-[0.75vw]">search</span>
                            <input
                                class="w-full pl-10 pr-4 py-2 bg-stone-50 dark:bg-stone-800 border-none rounded-xl text-[0.75vw] focus:ring-2 focus:ring-primary/20"
                            ...
                            <table id="table-view" class="w-full text-left border-collapse">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-6 py-4 text-[0.75vw] font-bold text-stone-500 uppercase">Branch ID
                                        </th>
                                        <th class="px-6 py-4 text-[0.75vw] font-bold text-stone-500 uppercase">Amount
                                            (฿)</th>
                                        <th class="px-6 py-4 text-[0.75vw] font-bold text-stone-500 uppercase">Category
                                        </th>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-1 dark:text-white">
                                ...
                                <div class="flex items-center gap-1 dark:text-white">
                                    ...
                                    <button
                                        class="w-8 h-8 flex items-center justify-center rounded-lg text-[0.75vw] font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-800 transition-all">2</button>
                                    <button
                                        class="w-8 h-8 flex items-center justify-center rounded-lg text-[0.75vw] font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-800 transition-all">3</button>
                                    <button
                                        class="w-8 h-8 flex items-center justify-center rounded-lg text-[0.75vw] font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-800 transition-all">4</button>
                                    <span class="px-2 text-stone-400">...</span>
                                    <button
                                        class="w-8 h-8 flex items-center justify-center rounded-lg text-[0.75vw] font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-800 transition-all">10</button>
                                </div>
                                <button
                                    class="px-3 py-1.5 text-[0.75vw] font-medium text-stone-600 dark:text-stone-400 hover:text-primary transition-colors">
                                    Next
                                </button>
                            </div>
                        </div>
            ...
            <div class="col-span-2 flex flex-col gap-3 min-h-0">
                ...
                <!-- Card 1: รายรับวันนี้ -->
                <div
                    class="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-2xl p-5 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                ...
                <!-- Card 3 -->
                <div id="card3"
                    class="bg-white dark:bg-stone-900 p-5 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 relative overflow-hidden">
                    ...
                    <div class="flex justify-between text-[1vw] text-stone-400 mt-1 uppercase font-bold">
                        <span>W1</span>
                        <span>W2</span>
                        <span>W3</span>
                        <span>W4</span>
                ...
                <!-- Card 4 -->
                <div id="card4"
                    class="bg-white dark:bg-stone-900 p-5 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800">
                    ...
                    <div class="mt-3 pt-4 border-t border-stone-100 dark:border-stone-800">
                        <div id="card4-progress"
                            class="flex h-2.5 w-full rounded-full overflow-hidden bg-stone-100 dark:bg-stone-800"></div>

                        <div class="flex justify-between mt-2 text-[1vw] text-stone-400 font-medium">
