...
<body>
    ...
    <header class="flex items-center justify-between p-4 border-b border-stone-200 bg-white shrink-0">
        <div class="flex items-center gap-4">
            ...
            <div
                class="size-9 w-[5rem] h-[5rem] bg-[#FF8021] rounded-xl flex items-center justify-center text-white shadow-sm shadow-primary/20">
        ...
        <div class="grid grid-cols-12 gap-4 h-full">
            ...
            <div class="col-span-10 flex flex-col gap-4">
                ...
                <div class="grid grid-cols-8 gap-4 flex-1 min-h-0">
                                ...
                                <div class="relative mb-2
                                    ...
                                    <div
                                        class="absolute bottom-0 bg-orange-500 rounded-full
                                            ...
                                            2xl:right-[-0.25vw] 2xl:w-[2.4vw] 2xl:h-[2.4vw]"></div>

                                    <!-- Scale -->
                                    <div class="absolute left-0 top-0 flex flex-col justify-between text-stone-500 pr-1.5 font-medium h-[29vh] text-[0.45vw] 2xl:h-[36vh] 2xl:text-[0.65vw] 2xl:pr-3">
                                        <span>140</span>
                                        <span>100</span>
                                        <span>60</span>
                                        <span>20</span>
                    ...
                    <!-- รูปภาพ 2 ส่วน (กลาง) -->
                    <div class="col-span-4 bg-white rounded-2xl border border-stone-200 shadow-sm p-4 flex-row items-center justify-center hover:ring-2 hover:ring-orange-400 transition-all duration-200 ">
                        <!-- <div class="flex-row "> -->

                        <!-- พื้นที่กลาง (รูปบน) -->
                        <div class="col-span-8 bg-white rounded-2xl p-2 flex-column items-center justify-center transition-all min-h-[300px]">
                            <div class="p-2 bg-stone-100 rounded-xl font-bold mb-2">Weather System with IoT App.</div>
                            <img src="images/weather.jpeg" alt="เครื่องมือ/อุปกรณ์" class="w-full max-h-[300px] object-cover rounded-xl">
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 2xl:gap-1 2xl:min-h-[300px]">
                            ...
                            <div class="col-span-8 bg-white rounded-2xl p-2 flex items-center justify-center transition-all">
                                <img src="images/weather.jpeg" alt="เครื่องมือ/อุปกรณ์" class="w-full max-h-[400px] object-cover rounded-xl">
                            </div>
