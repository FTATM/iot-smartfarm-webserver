        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-10 flex flex-col justify-between gap-3 min-h-0">
                ...
                <div class="grid grid-cols-8 gap-3 flex-1 min-h-0">
                    ...
                    <div class="col-span-1 bg-white dark:bg-stone-900 p-[0.5vw] rounded-2xl border border-stone-200 shadow-sm flex items-center justify-center hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0">
                        ...
                        <div class="rounded-2xl p-[0.25vw] flex flex-col h-full transition-all duration-200">
                            ...
                            <div class="flex-1 flex flex-col items-center justify-center pt-1">
                                <div class="relative mb-2 w-[3.8vw] h-[30vh]">
                                    <!-- Thermometer Body -->
                                    <div class="absolute right-0 top-0 bg-stone-300 rounded-t-full w-[1vw] h-[29.5vh] "></div>
                                    ...
                                    <!-- Scale -->
                                    <div class="absolute left-0 top-0 flex flex-col justify-between text-stone-500 pr-1.5 font-medium h-[29vh] text-[0.75vw]">
                                        <span>140</span>
                                        <span>100</span>
                                        <span>60</span>
                                        <span>20</span>
                    ...
                    <!-- รูปภาพ 2 ส่วน (กลาง) -->
                    <div class="box col-span-4 flex flex-col bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-700 shadow-sm p-2 2xl:p-3 hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0">
                        ...
                        <div class="rounded-xl px-[1.5vw] flex flex-col items-center justify-center">
                            ...
                            <img src="images/weather.jpeg" alt="เครื่องมือ/อุปกรณ์" class="object-contain rounded-lg" style="max-height: 30vh;" />
                        </div>
                        ...
                        <div class="flex flex-col flex-1 px-[1.5vw]">
                            ...
                            <div class="flex justify-between flex-1 gap-1.5 ">
                                ...
                                <div class="col-span-8 bg-white rounded-2xl p-2 flex items-center justify-center transition-all">
                                    <img src="images/weather.jpeg" alt="เครื่องมือ/อุปกรณ์" class="object-contain rounded-md" style="max-height: 30vh;" />
                                </div>
            ...
            <div class="col-span-2 flex flex-col gap-3 min-h-0">
                ...
                <div class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 overflow-hidden">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <!-- ต่ำสุด -->
                        <div class="bg-cyan-50/50 dark:bg-cyan-900/20 p-[0.5vw] rounded-xl text-center border border-cyan-100 dark:border-cyan-100/10 flex flex-col justify-center">
                        ...
                        <!-- สูงสุด -->
                        <div class="bg-orange-50/50 dark:bg-orange-900/20 p-[0.5vw] rounded-xl text-center border border-orange-100 dark:border-orange-100/10 flex flex-col justify-center">
                ...
                <div class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 overflow-hidden flex-1">
                    <div class="flex items-center gap-2 mb-2">
                    ...
                    <div class="grid grid-cols-4 gap-2 text-center flex-1" id="wind-forecast">
                        <!-- Loading state -->
                        <div class="bg-stone-50 flex flex-col justify-between dark:bg-stone-900/20 p-2 rounded-lg border border-stone-200 dark:border-orange-100/20">
                            <p class="text-[0.75vw] text-[#ff8021] font-bold mb-1">ตอนนี้</p>
                            <p id="wind-spd-now" class="text-[0.65vw] font-bold text-slate-800 dark:text-slate-100">--</p>
                        ...
                        <div class="p-2 flex flex-col justify-between">
                            ...
                            <p id="wind-spd-1hr" class="text-[0.65vw] font-bold text-slate-600 dark:text-slate-200">--</p>
                        ...
                        <div class="p-2 flex flex-col justify-between">
                            ...
                            <p id="wind-spd-2hr" class="text-[0.65vw] font-bold text-slate-600 dark:text-slate-200">--</p>
                        ...
                        <div class="p-2 flex flex-col justify-between">
                            ...
                            <p id="wind-spd-3hr" class="text-[0.65vw] font-bold text-slate-600 dark:text-slate-200">--</p>
                ...
                <div class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 overflow-hidden flex-1">
                    ...
                    <div class="grid grid-cols-4 gap-2 flex-1 text-[0.75vw] text-center font-bold" id="humidity-forecast">
                        <div class="text-slate-400 dark:text-slate-300">1 ชม.<br /><span class="text-slate-700 dark:text-slate-100">--</span></div>
                        <div class="text-slate-400 dark:text-slate-300">2 ชม.<br /><span class="text-slate-700 dark:text-slate-100">--</span></div>
                        <div class="text-slate-400 dark:text-slate-300">3 ชม.<br /><span class="text-slate-700 dark:text-slate-100">--</span></div>
                        <div class="text-slate-400 dark:text-slate-300">4 ชม.<br /><span class="text-slate-700 dark:text-slate-100">--</span></div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 overflow-hidden flex-1">
                    ...
                    <!-- สภาพอากาศปัจจุบัน -->
                    <div id="current-weather" class="flex items-center justify-between mb-2 bg-stone-50 dark:bg-stone-900/20 p-[0.5vw] rounded-xl border border-stone-100">
                        <div class="flex items-center gap-3">
                            <span class="material-symbols-outlined text-yellow-500 text-[1vw]"
                                id="current-icon">wb_sunny</span>
                            <div>
                                <p class="text-[0.75vw] font-bold text-slate-400 dark:text-slate-200 uppercase">ตอนนี้</p>
                                <p class="font-bold text-[0.5vw] text-slate-800 dark:text-slate-400" id="current-condition">--</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-[0.75vw] font-bold text-slate-400 dark:text-slate-200 uppercase">ปริมาณฝน</p>
                            <p class="font-bold text-[0.5vw] text-[#ff8021] dark:text-white" id="current-rain">-- mm/hr</p>
                        </div>
                    </div>
