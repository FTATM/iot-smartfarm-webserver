...
<body class="h-screen overflow-hidden flex flex-col">
    ...
    <header class="flex items-center justify-between p-4 border-b border-stone-200 bg-white shrink-0">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-[#1d130c] text-[3rem] font-bold leading-none">Chicken Dashboard</h1>
                <p class="text-[1.5rem] text-stone-500 font-medium uppercase tracking-wider mt-0.5">Chicken Farm Intelligence Dashboard</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-4 gap-3 2xl:gap-3 flex-1 min-h-0">
                    ...
                    <div class="col-span-2 grid grid-rows-5 bg-white rounded-2xl border border-stone-200 shadow-sm p-2 2xl:p-3 hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0 overflow-hidden">
                        ...
                        <div class="row-span-2 bg-red rounded-xl p-4 flex flex-col items-center justify-center flex-shrink-0">
                            <div class="p-1 2xl:p-1.5 bg-stone-100 rounded-lg font-bold mb-1 2xl:mb-1.5 text-[2rem] text-center w-full">Smart chicken farming system with AI health monitoring cameras and IoT app.</div>
                        ...
                        <div class="bg-white border border-stone-200 rounded-2xl p-2 shadow-sm flex flex-col flex-1 hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0">
                            <div class="flex justify-between items-center mb-1 shrink-0 2xl:p-8">
                                ...
                                <div class="flex items-center gap-1 bg-stone-100 p-0.5 rounded-lg border border-stone-200">
                                    <button id="btnDoDay" class="px-1.5 py-0.5 text-[1.25rem] font-bold rounded-md bg-white shadow-sm text-orange-600" type="button">1 วัน</button>
                                    <button id="btnDoMonth" class="px-1.5 py-0.5 text-[1.25rem] font-bold rounded-md text-stone-500 hover:bg-white/50" type="button">1 เดือน</button>
                                </div>
                            </div>
            ...
            <div class="col-span-2 grid grid-rows-4 gap-3 min-h-0">
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    ...
                    <div class="grid grid-cols-2 gap-2 2xl:gap-4 2xl:mt-4">
                        ...
                        <div class="bg-stone-50 rounded-lg p-1.5 flex flex-col justify-center 2xl:px-2 h-full">
                            <span class="text-[1.5rem] text-stone-400 font-bold uppercase">ปริมาณ</span>
                        ...
                        <div class="col-span-2 bg-primary/5 rounded-lg p-1.5 2xl:py-8 border border-primary/10 flex justify-between items-center">
                            <span class="text-[1.5rem] text-primary font-bold uppercase">ปริมาณรวมที่ต้องกิน(กรัม/วัน)</span>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    <div class="flex items-center gap-2 mb-2 2xl:p-2">
                        ...
                        <h3 class="text-[1.5rem] font-bold text-stone-700 2xl:pl-4">ความชื้นและแสงสว่างที่เหมาะสม</h3>
                    </div>

                    <div class="grid grid-cols-2 gap-1.5 2xl:gap-2 mb-1">
                        <div class="bg-stone-50 rounded-lg p-1 flex flex-col justify-center">
                            <span class="text-[1.5rem] text-stone-400 font-bold uppercase">ความชื้นสูงสุด</span>
                            <span class="text-[1.5rem] font-black text-stone-800" id="humidity">-</span>
                        </div>
                        <div class="bg-stone-50 rounded-lg p-1 flex flex-col justify-center">
                            <span class="text-[1.5rem] text-stone-400 font-bold uppercase">เวลาให้แสง</span>
                            <span class="text-[1.5rem] font-black text-primary" id="light-time">-</span>
                        </div>
                    </div>

                    <div class="space-y-1">
                        <div class="bg-stone-50 rounded-lg p-0.5 border">
                            <p class="text-[1.5rem] text-black-600 font-bold text-center" id="light-recommentation">-</p>
                        </div>
                        <div class="bg-stone-50 rounded-lg p-1 flex justify-between items-center">
                            <span class="text-[1.5rem] text-primary font-bold uppercase">ชั่วโมงรวมวันนี้</span>
                            <span class="text-[1.5rem] font-black text-stone-800" id="total-hours">-</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 group shrink-0 overflow-hidden">
                    <div class="flex items-center gap-2 mb-2 2xl:p-2">
                        ...
                        <h3 class="text-[1.5rem] font-bold text-stone-700 2xl:pl-4">ต้นทุนทรัพยากรไฟฟ้าและน้ำทั้งหมด</h3>
                    </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    <div class="flex items-center gap-2 mb-2 2xl:p-2">
                        ...
                        <h3 class="text-[1.5rem] font-bold text-stone-700 2xl:pl-4">ต้นทุนรวมทั้งหมด</h3>
                    </div>
