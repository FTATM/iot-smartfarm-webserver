...
<body>
    ...
    <header class="flex items-center justify-between p-4 border-b border-stone-200 bg-white shrink-0">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-[#1d130c] text-[3rem] text-lg font-bold leading-none">Outdoor Dashboard</h1>
                <p class="text-[1.5rem] text-stone-500 font-medium uppercase tracking-wider mt-1">Outdoor Intelligence Dashboard</p>
            </div>
        </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-4 shadow-sm hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0">
                    ...
                    <div id="tasks-container" class="space-y-2 2xl:space-y-8 2xl:gap-8 2xl:px-8">
                        ...
                        <div class="bg-stone-50 p-2 rounded-lg border border-stone-100 2xl:px-8">
                            <p class="text-[1.25rem] text-slate-500 font-bold uppercase tracking-wider mb-0.5">สิ่งที่ต้องทำ</p>
                            <p class="font-medium text-[1.5rem] text-slate-800" id="task-todo">-</p>
                        </div>

                        <!-- ดินที่ควรจะเป็น -->
                        <div class="flex items-center justify-between bg-stone-50 p-1.5 2xl:px-8 rounded-lg border border-stone-100">
                            <div>
                                <p class="text-[1.25rem] text-slate-500 font-bold uppercase tracking-wider">ดินที่ควรจะเป็น</p>
                                <p class="text-[1.5rem] font-bold text-orange-600" id="soil-moisture">-</p>
                            </div>
                            <div class="text-right">
                                <p class="text-[1.25rem] text-slate-500 font-bold uppercase tracking-wider">pH Level</p>
                                <p class="text-[1.5rem] font-bold text-slate-700" id="soil-ph">-</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="watering-container" class="space-y-2 2xl:px-8">
                        ...
                        <div class="grid grid-cols-2 gap-1 2xl:gap-8 2xl:mb-8">
                            <div class="bg-blue-50 p-2 2xl:px-8 rounded-lg border border-blue-100">
                                <p class="text-[1.25rem] text-blue-500 font-bold uppercase mb-0.5">การให้น้ำ</p>
                                <p class="text-[1.5rem] font-bold text-blue-600" id="watering-schedule">-</p>
                            </div>
                            <div class="bg-stone-50 p-2 2xl:px-8 rounded-lg border border-stone-100">
                                <p class="text-[1.25rem] text-slate-500 font-bold uppercase mb-0.5">การใส่ปุ๋ย</p>
                                <p class="text-[1.5rem] font-bold text-slate-800" id="fertilizer-schedule">-</p>
                            </div>
                        </div>

                        <!-- โรค/ศัตรูพืช -->
                        <div class="bg-red-50 p-2 2xl:px-8 rounded-lg border border-red-100">
                            <p class="text-[1.25rem] text-red-500 font-bold uppercase tracking-wider mb-0.5">โรค/ศัตรูพืชที่ต้องระวัง</p>
                            <p class="text-[1.5rem] font-bold text-red-600" id="pest-warning">-</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="total-cost-container" class="space-y-1 2xl:space-y-4 2xl:px-8">
                        ...
                        <div class="flex items-center justify-between p-1 2xl:px-4 bg-green-50 rounded-md border border-green-100">
                            <div class="flex items-center gap-1 2xl:px-1">
                                ...
                                <span class="text-[1.25rem] 2xl:px-4 font-bold text-green-700 uppercase">ของใช้วันนี้</span>
                            </div>
                            <span class="text-[1.25rem] font-bold text-green-700" id="daily-supplies">-</span>
                        </div>

                        <div class="flex items-center justify-between p-1 2xl:px-4 bg-yellow-50 rounded-md border border-yellow-100">
                            <div class="flex items-center gap-1 2xl:px-1">
                                <span class="material-symbols-outlined text-yellow-600 text-[1.5rem]">bolt</span>
                                <span class="text-[1.25rem] 2xl:px-4 font-bold text-yellow-700 uppercase">น้ำและไฟ</span>
                            </div>
                            <span class="text-[1.25rem] font-bold text-yellow-700" id="utility-cost">-</span>
                        </div>

                        <div class="flex items-center justify-between p-1 2xl:px-4 bg-red-50 rounded-md border border-red-100">
                            <div class="flex items-center gap-1 2xl:px-1">
                                <span class="material-symbols-outlined text-red-600 text-[1.5rem]">more_horiz</span>
                                <span class="text-[1.25rem] 2xl:px-4 font-bold text-red-700 uppercase">อื่นๆ</span>
                            </div>
                            <span class="text-[1.25rem] font-bold text-red-700" id="other-cost">-</span>
                        </div>

                        <!-- Total -->
                        <div class="pt-1.5 mt-0.75 2xl:px-4 border-t border-slate-200 flex justify-between items-center">
                            <span class="font-bold text-slate-800 uppercase text-[1.15rem] tracking-wider">รวม</span>
                            <span class="font-bold text-[1.75rem] text-primary" id="total-cost">-</span>
                        </div>
                    </div>
                </div>
            </div>
