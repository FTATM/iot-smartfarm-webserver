                ...
                <div class="row-span-7 grid grid-cols-4 gap-3 2xl:gap-3 flex-1 min-h-0">
                    ...
                    <div class="box col-span-2 flex flex-col bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-700 shadow-sm p-2 2xl:p-3 hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0">
                        ...
                        <div class="rounded-xl px-[1.5vw] flex flex-col items-center justify-center">
                            ...
                            <img src="images/outdoor_main.png" alt="เครื่องมือ/อุปกรณ์" class="object-contain rounded-lg" style="max-height: 30vh;" />
                        </div>
                        ...
                        <div class="flex flex-col flex-1 px-[1.5vw]">
                            ...
                            <div class="flex justify-between flex-1 gap-1.5 ">
                                ...
                                <div class=" rounded-lg p-0.5 flex items-center justify-center overflow-hidden min-h-0">
                                    <img src="images/outdoor.jpeg" alt="เครื่องมือ/อุปกรณ์" class="object-contain rounded-md" style="max-height: 30vh;" />
                                </div>
                                <div class="flex flex-col justify-between">
            ...
            <div class="col-span-2 flex flex-col gap-3 min-h-0">
                ...
                <div class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 overflow-hidden">
                    <div class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-primary text-[2vw]">checklist</span>
                    ...
                    <div id="tasks-container" class="grid grid-cols-2 gap-3">
                        <div class="bg-stone-50 dark:bg-stone-800 rounded-lg py-[1vh] px-[0.5vw] flex flex-col justify-center h-full">
                            <span class="text-[0.75vw] text-stone-400 dark:text-stone-500 font-bold uppercase">ดินที่ควรจะเป็น</span>
                            <span class="text-[0.75vw] font-black text-stone-800 dark:text-stone-100" id="soil-moisture">-</span>
                        </div>
                        <div class="bg-stone-50 dark:bg-stone-800 rounded-lg py-[1vh] px-[0.5vw] flex flex-col justify-center h-full">
                            <span class="text-[0.75vw] text-stone-400 dark:text-stone-500 font-bold uppercase">pH Level</span>
                            <span class="text-[0.75vw] font-black text-stone-800 dark:text-stone-100" id="soil-ph">-</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 overflow-hidden">
                    <div class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-primary text-[2vw]">water_drop</span>
                    ...
                    <div id="watering-container" class="space-y-2 ">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-stone-50 dark:bg-stone-800 rounded-lg py-[1vh] px-[0.5vw] flex flex-col justify-center h-full">
                                ...
                                <p class="text-[0.75vw] text-blue-500 dark:text-blue-400 font-bold uppercase mb-0.5">การให้น้ำ</p>
                                <p class="text-[0.75vw] font-bold text-blue-600 dark:text-white" id="watering-schedule">-</p>
                            </div>
                            <div class="bg-stone-50 dark:bg-stone-800 rounded-lg py-[1vh] px-[0.5vw] flex flex-col justify-center h-full">
                                ...
                                <p class="text-[0.75vw] text-yellow-500 dark:text-yellow-400 font-bold uppercase mb-0.5">การใส่ปุ๋ย</p>
                                <p class="text-[0.75vw] font-bold text-blue-600 dark:text-white" id="fertilizer-schedule">-</p>
                            </div>
                        </div>

                        <!-- โรค/ศัตรูพืช -->
                        <!-- <div class="bg-red-50 dark:bg-red-800/20 p-2 rounded-lg border border-red-100 dark:border-red-800"> -->
                        <div class="bg-stone-50 dark:bg-stone-800/20 p-2 rounded-lg border border-stone-100 dark:border-stone-800">
