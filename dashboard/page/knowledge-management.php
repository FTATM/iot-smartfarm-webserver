        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-10 flex flex-col gap-3 justify-between">
                <div class="flex justify-between bg-red-500">
                    ...
                    <div class="flex">
                        <div id="edit-table" class="border border-yellow-400 bg-yellow-300 hover:bg-yellow-400 w-[3vw] text-center px-3 py-2 cursor-pointer" onclick="ModalConfirmEditTable()">แก้ไข</div>
                        <div id="delete-table" class="border border-red-600 bg-red-400 hover:bg-red-500 w-[3vw] text-center px-3 py-2 cursor-pointer" onclick="ModalConfirmDeleteTable()">ลบ</div>
                    </div>
                </div>
