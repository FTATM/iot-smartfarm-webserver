        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-10 flex flex-col gap-3 justify-between">
                <div class="flex justify-between bg-red-500">
                    ...
                    <div class="flex">
                        <div id="cancel-table" class="border border-stone-400 bg-stone-200 hover:bg-stone-400 w-[3vw] text-center px-1 py-2 cursor-pointer hidden" onclick="ModalConfirmCancelTable()">ยกเลิก</div>
                        <div id="save-table" class="border border-lime-600 bg-lime-500 hover:bg-lime-400 w-[3vw] text-center text-white px-1 py-2 cursor-pointer hidden" onclick="ModalConfirmSaveTable()">บันทึก</div>
                        <div id="edit-table" class="border border-yellow-400 bg-yellow-400 hover:bg-yellow-300 w-[3vw] text-center px-3 py-2 cursor-pointer" onclick="ModalConfirmEditTable()">แก้ไข</div>
                        <div id="delete-table" class="border border-red-600 bg-red-500 hover:bg-red-400 w-[3vw] text-center text-white px-3 py-2 cursor-pointer" onclick="ModalConfirmDeleteTable()">ลบ</div>
                    </div>
                </div>
