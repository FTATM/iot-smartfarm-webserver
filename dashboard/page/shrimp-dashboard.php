...
<body class="h-screen overflow-hidden flex flex-col">
    ...
    <header class="flex items-center justify-between p-4 border-b border-stone-200 bg-white shrink-0">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-[#1d130c] text-[1.5vw] font-bold leading-none">Shrimp Dashboard</h1>
                <p class="text-[0.75vw] text-stone-500 font-medium uppercase tracking-wider mt-0.5">Shrimp Farm Intelligence Dashboard</p>
            </div>
        </div>
                ...
                <div class="row-span-7 grid grid-cols-4 gap-3 flex-1 min-h-0">
                    ...
                    <div class="col-span-2 grid grid-rows-5 bg-white rounded-2xl border border-stone-200 shadow-sm p-2 2xl:p-3 hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0 overflow-hidden">
                        ...
                        <div class="row-span-2 bg-red rounded-xl p-4 flex flex-col items-center justify-center flex-shrink-0">
                            <div class="p-1 .5 bg-stone-100 rounded-lg font-bold mb-1 text-[0.9vw] text-center w-full">Smart Vertical Raised Shrimp Farming System(RAS) with IoT App</div>
                            <img src="images/shrimp_main.jpg" alt="เครื่องมือ/อุปกรณ์" class="h-full object-contain rounded-lg">
                        </div>
            ...
            <div class="col-span-2 grid grid-rows-4 gap-2.5 min-h-0">
                    ...
                    <div>
                        <div class="grid grid-cols-2 gap-2  " id="feeding-info">
                            <div class="bg-stone-50 rounded-lg p-1.5 flex flex-col justify-center 2xl:p-2 h-full">
                                <span class="text-[1vw] text-stone-400 font-bold uppercase">จำนวนมื้อ</span>
                                <span class="text-[1vw] font-black text-stone-800" id="meals-count">--</span>
                            </div>
                            <div class="bg-stone-50 rounded-lg p-1.5 flex flex-col justify-center 2xl:px-2 h-full">
                                <span class="text-[1vw] text-stone-400 font-bold uppercase">ปริมาณ(กรัม)</span>
                                <span class="text-[1vw] font-black text-stone-800" id="volume-meal">-</span>
                            </div>
                            <div class="col-span-2 bg-primary/5 rounded-lg p-1.5 py-2 border border-primary/10 flex justify-between items-center">
                                <span class="text-[1vw] text-primary font-bold uppercase">ปริมาณรวมที่ต้องกิน(กรัม)</span>
                                <span class="text-[1vw] font-black text-primary" id="total-meal-per-day">--</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 group shrink-0 overflow-hidden">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="material-symbols-outlined clarity--coin-bag-line text-primary text-[1vw]"></span>
                        <h3 class="text-[1vw] font-bold text-stone-700 2xl:pl-4">ต้นทุนทรัพยากรทั้งหมด</h3>
                    </div>
                    <div class="grid grid-cols-2 gap-1.5 mb-1.5">
                        <div class="bg-stone-50 rounded-lg p-1 flex flex-col justify-center">
                            <span class="text-[1vw] text-stone-400 font-bold uppercase leading-tight">ค่าน้ำประปา</span>
                            <span class="text-[1vw] text-center font-black text-stone-800 leading-tight" id="water-usage">-</span>
                        </div>
                        <div class="bg-stone-50 rounded-lg p-1 flex flex-col justify-center">
                            <span class="text-[1vw] text-stone-400 font-bold uppercase leading-tight">ค่าไฟฟ้า</span>
                            <span class="text-[1vw] text-center font-black text-stone-800 leading-tight" id="electricity-usage">-</span>
                        </div>
                    </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    <div class="flex items-center gap-2 mb-2 2xl:p-2">
                        ...
                        <h3 class="text-[1vw] font-bold text-stone-700 2xl:pl-4">คุณภาพน้ำที่เหมาะสม</h3>
                    </div>
                    <div>
                        <div>
                            <table class="w-full">
                                <tbody class="text-[0.75vw]  divide-y divide-stone-50">
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] 2xl:pl-4">DO</td>
                                        <td class="py-1 text-right font-bold text-stone-700 2xl:pr-4">3.0-7.0 mg/L</td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] 2xl:pl-4">pH</td>
                                        <td class="py-1 text-right font-bold text-stone-700 2xl:pr-4">7.5 - 8.5</td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] 2xl:pl-4">EC</td>
                                        <td class="py-1 text-right font-bold text-stone-700 2xl:pr-4">23K-45K μS/cm</td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] 2xl:pl-4">Temp</td>
                                        <td class="py-1 text-right font-bold text-stone-700 2xl:pr-4">28-32 °C</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-3 shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    <div class="flex items-center gap-2 mb-2 2xl:p-2">
                        ...
                        <h3 class="text-[1vw] font-bold text-stone-700 2xl:pl-4">การปรับอาหาร</h3>
                    </div>
                    <div class="flex flex-col gap-1 2xl:px-2 ">
                        <div class="flex items-center justify-between px-2 py-2 bg-success/5 border border-success/10 rounded-lg">
                            <span class="text-[0.75vw] font-bold text-success uppercase 2xl:pl-4">หมดเกลี้ยง</span>
                            <span class="text-[0.75vw] text-stone-700 2xl:pr-4">+5 ถึง +10%</span>
                        </div>
                        <div class="flex items-center justify-between px-2 py-2 bg-warning/5 border border-warning/10 rounded-lg">
                            <span class="text-[0.75vw] font-bold text-warning uppercase 2xl:pl-4">เหลือเล็กน้อย</span>
                            <span class="text-[0.75vw] text-stone-700 2xl:pr-4">คงที่ / -5%</span>
                        </div>
                        <div class="flex items-center justify-between px-2 py-2 bg-danger/5 border border-danger/10 rounded-lg">
                            <span class="text-[0.75vw] font-bold text-danger uppercase 2xl:pl-4">เหลือเยอะ</span>
                            <span class="text-[0.75vw] text-stone-700 2xl:pr-4">งด / -50%</span>
                        </div>
                    </div>
                </div>
            </div>
