    ...
    <main class="flex-1 flex flex-col p-[0.5vw] gap-3 overflow-hidden min-h-0">
        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-2 flex flex-col gap-2.5 min-h-0">
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    ...
                    <div>
                        <div class="grid grid-cols-2 gap-2  " id="feeding-info">
                            <div class="bg-stone-50 rounded-lg p-[0.25vw] flex flex-col justify-center h-full">
                            ...
                            <div class="bg-stone-50 rounded-lg p-[0.25vw] flex flex-col justify-center 2xl:px-2 h-full">
                                <span class="text-[0.75vw] text-stone-400 font-bold uppercase">ปริมาณ(กรัม)</span>
                ...
                <div class="bg-white border border-stone-200 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 group shrink-0 overflow-hidden">
                    <div class="flex justify-between">
                        ...
                        <div onclick="calculateElectricityAndWater('card-2')" class="flex items-center gap-2 mb-2">
                    ...
                    <div class="grid grid-cols-2 gap-1.5 mb-1.5 ">
                        <div class="bg-stone-50 rounded-lg px-[0.45vw] flex flex-col justify-center">
                            ...
                            <div class="flex justify-center p-[0.5vw] text-center">
                                <span id="card-2-water-usage" class="text-[1vw] text-center font-black text-stone-800 leading-tight">-</span>
                        ...
                        <div class="bg-stone-50 rounded-lg px-[0.45vw] flex flex-col justify-center">
                            ...
                            <div class="flex justify-center p-[0.5vw] text-center">
                                <span id="card-2-electricity-usage" class="text-[1vw] text-center font-black text-stone-800 leading-tight">-</span>
                                <span class="text-[0.6vw] flex items-end text-slate-500">THB</span>
                            </div>
                        </div>
                    </div>
