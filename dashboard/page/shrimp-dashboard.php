    ...
    <main
        ...
        <div class="grid grid-cols-12 gap-3 h-full min-h-0">
            ...
            <div class="col-span-10 grid grid-rows-8 gap-3 min-h-0">
                ...
                <div class="row-span-7 grid grid-cols-4 gap-3 2xl:gap-3 flex-1 min-h-0">
                        ...
                        <div class="flex flex-col flex-1 px-[1.5vw]">
                            ...
                            <div class="flex justify-between flex-1 gap-1.5 ">
                                ...
                                <div class=" rounded-lg p-0.5 flex items-center justify-center overflow-hidden min-h-0">
                                    <img src="images/shrimp.png" alt="เครื่องมือ/อุปกรณ์"
                    ...
                    <div class="col-span-2 flex flex-col gap-3 min-h-0">
                        ...
                        <div
                            class="bg-white dark:bg-stone-900 box border border-stone-200 dark:border-stone-700 rounded-2xl p-2 shadow-sm flex flex-col flex-1 hover:ring-2 hover:ring-orange-400 transition-all duration-200 min-h-0">
                            <div class="flex justify-between items-center mb-1 shrink-0">
                                <div>
                                    <h2
                                        class="text-[1vw] font-bold text-stone-800 dark:text-stone-100 flex items-center gap-1.5">
                                    ...
                                    <p id="title-graph-sensor-sub"
                                        class="text-[0.75vw] text-stone-400 dark:text-stone-500 font-medium uppercase tracking-wider mt-0.5">
                                        Loading data...
                                    </p>
                                </div>
                            </div>
                            <div
                                class="flex-1 min-h-0 relative border-l border-b border-stone-200 dark:border-stone-700 rounded-md">
            ...
            <div class="col-span-2 flex flex-col gap-2.5 min-h-0">
                ...
                <div
                    class="bg-white dark:bg-stone-900 flex-1 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 shrink-0 overflow-hidden">
                    ...
                    <div>
                        <div class="grid grid-cols-2 gap-2  " id="feeding-info">
                            <div
                                class="bg-stone-50 dark:bg-stone-900 rounded-lg p-[0.25vw] flex flex-col justify-center h-full">
                                <span
                                    class="text-[0.75vw] text-stone-400 dark:text-stone-500 font-bold uppercase">จำนวนมื้อ</span>
                                <span class="text-[0.75vw] font-black text-slate-900 dark:text-white"
                                    id="meals-count">--</span>
                            </div>
                            <div
                                class="bg-stone-50 dark:bg-stone-900 rounded-lg p-[0.25vw] flex flex-col justify-center 2xl:px-2 h-full">
                                <span
                                    class="text-[0.75vw] text-stone-400 dark:text-stone-500 font-bold uppercase">ปริมาณ(กรัม)</span>
                                <span class="text-[0.75vw] font-black text-slate-900 dark:text-white"
                                    id="volume-meal">-</span>
                            </div>
                            <div
                                class="col-span-2 bg-primary/5 rounded-lg p-1.5 py-2 border border-primary/10 dark:border-primary/20 flex justify-between items-center">
                                <span
                                    class="text-[0.75vw] text-primary font-bold uppercase">ปริมาณรวมที่ต้องกิน(กรัม)</span>
                ...
                <div
                    class="bg-white dark:bg-stone-900 flex-1 box border border-stone-200 dark:border-stone-700 rounded-2xl p-[0.5vw] shadow-sm flex flex-col hover:ring-2 hover:ring-orange-400 transition-all duration-200 group overflow-hidden">
                    <div class="flex justify-between">
                        ...
                        <div onclick="calculateElectricityAndWater('card-2')"
                    ...
                    <div class="grid grid-cols-2 gap-[0.5vw] mt-[0.5vh]">
                        ...
                        <div class="bg-stone-50 dark:bg-stone-900 rounded-lg p-[0.45vw] flex flex-col justify-center">
                            ...
                            <div class="flex justify-center p-[0.45vw] text-center">
                                <span id="card-2-electricity-usage"
                                    class="text-[1vw] text-center font-black text-stone-800 dark:text-stone-100 leading-tight">-</span>
                                <span class="text-[0.6vw] flex items-end text-slate-500 dark:text-stone-400"> THB</span>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center mb-2">
                        <div
                            class="p-2 bg-orange-50 dark:bg-orange-900/20 text-primary rounded-lg flex items-center justify-center">
                            <span class="ic--round-waves"></span>
                        </div>
                        <h3 class="ml-2 text-[1vw] font-bold text-stone-700 dark:text-stone-200">
                            คุณภาพน้ำที่เหมาะสม
                        </h3>
                        ...
                        <div>
                            <table class="w-full">
                                <tbody class="text-[0.75vw]  divide-y divide-stone-50">
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] dark:text-slate-300 2xl;pl-4">DO
                                        </td>
                                        <td class="py-1 text-right  text-stone-700  dark:text-white 2xl;pr-4">3.0-7.0
                                            mg/L</td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] dark:text-slate-300 2xl;pl-4">pH
                                        </td>
                                        <td class="py-1 text-right  text-stone-700 dark:text-white 2xl;pr-4">7.5 - 8.5
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] dark:text-slate-300 2xl;pl-4">EC
                                        </td>
                                        <td class="py-1 text-right  text-stone-700 dark:text-white 2xl;pr-4">23K-45K
                                            μS/cm</td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-1 text-stone-500 text-[0.75vw] dark:text-slate-300 2xl;pl-4">Temp
                                        </td>
                                        <td class="py-1 text-right  text-stone-700 dark:text-white 2xl;pr-4">28-32 °C
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div
                    ...
                    <div class="flex items-center mb-2">
                        <div
                            class="p-2 bg-orange-50 dark:bg-orange-900/20 text-primary rounded-lg flex items-center justify-center">
                            <span class="material-symbols--rule-rounded"></span>
                        </div>
                        <h3 class="ml-2 text-[1vw] font-bold text-stone-700 dark:text-stone-200">
                            การปรับอาหาร
                        </h3>
                    ...
                    <div class="flex flex-col gap-1 2xl:px-2 ">
                        <div
                            class="flex items-center justify-between px-2 py-2 bg-success/5 border border-success/10 dark:bg-green-900 rounded-lg">
                            <span
                                class="text-[0.75vw] font-bold text-success dark:text-green-400 uppercase ">หมดเกลี้ยง</span>
                            <span class="text-[0.75vw] text-stone-700 dark:text-white 2xl:pr-4">+5 ถึง +10%</span>
                        </div>
                        <div
                            class="flex items-center justify-between px-2 py-2 bg-warning/5 border border-warning/10 dark:bg-yellow-800 rounded-lg">
                            <span
                                class="text-[0.75vw] font-bold text-warning dark:text-yellow-400 uppercase ">เหลือเล็กน้อย</span>
                            <span class="text-[0.75vw] text-stone-700 dark:text-white 2xl:pr-4">คงที่ / -5%</span>
                        </div>
                        <div
                            class="flex items-center justify-between px-2 py-2 bg-danger/5 border border-danger/10 dark:bg-red-900 rounded-lg">
                            <span
                                class="text-[0.75vw] font-bold text-danger dark:text-red-100 uppercase ">เหลือเยอะ</span>
