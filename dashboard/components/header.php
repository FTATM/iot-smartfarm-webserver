        ...
        <div class="flex flex-col items-end">
            <button onclick="toggleDarkMode()"
                ...
                <svg id="icon-moon" xmlns="http://www.w3.org/2000/svg"
                    class="w-4 h-4 text-stone-600 dark:text-stone-300" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 12.79A9 9 0 1111.21 3a7 7 0 009.79 9.79z" />
                </svg>
                <!-- Sun icon (แสดงตอน Dark mode) -->
                <svg id="icon-sun" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-yellow-400"
